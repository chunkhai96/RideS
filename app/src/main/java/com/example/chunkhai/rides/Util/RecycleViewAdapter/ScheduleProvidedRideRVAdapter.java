...
public class ScheduleProvidedRideRVAdapter extends RecyclerView.Adapter<ScheduleProvidedRideRVAdapter.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tvDateTitle, tvDepartureDateTime, tvFromTitle, tvToTitle, tvCarpooler;
        ImageView ivWarning;
        ...
        public MyViewHolder(View view) {
            ...
            tvCarpooler = (TextView) view.findViewById(R.id.tvCarpooler);
    ...
    public ScheduleProvidedRideRVAdapter(Context mContext, List<ProvidedRide> providedRides) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_row_schedule_provided_ride, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        query.addValueEventListener(new ValueEventListener() {
                ...
                if(dataSnapshot.exists()){
                    for(DataSnapshot ds : dataSnapshot.getChildren()){
                        ...
                        if(sr.getRs_status() == mContext.getResources().getInteger(R.integer.sharedride_status_accept)
                                || sr.getRs_status() == mContext.getResources().getInteger(R.integer.sharedride_status_complete)){
                            carpooler ++;
                        }
                        if(sr.getRs_status() == mContext.getResources().getInteger(R.integer.sharedride_status_requested)){
                            requester ++;
                        }
                    }
                }
                holder.tvCarpooler.setText(Long.toString(carpooler));
                if(requester > 0) {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.d(TAG, "onCancelled: error on getting carpooler number for ride #" + providedRide.getPr_id());
                holder.tvCarpooler.setText("0");
            }
        });
